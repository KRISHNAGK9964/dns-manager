  ...
  return (
    <div className="">
      ...
      <div className="border-b">
        ...
        <div className=" flex justify-end gap-4 p-6 flex-grow">
          <div className="p-2 px-4 border rounded-md hover:bg-gray-50">Buy</div>
          <div className="p-2 px-4 border rounded-md hover:bg-gray-50">Add</div>
          <div className="p-2 px-4 border rounded-md hover:bg-gray-50">Transfer In</div>
        </div>
      </div>
      </div>
